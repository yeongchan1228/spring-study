package spring3.spring3study.config.proxy.v2_dynamicproxy;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import spring3.spring3study.app.proxy.v1.*;
import spring3.spring3study.config.proxy.v2_dynamicproxy.handler.LogTraceBasicHandler;
import spring3.spring3study.config.proxy.v2_dynamicproxy.handler.LogTraceFilterHandler;
...
public class DynamicProxyFilterConfig {
    ...
    public OrderControllerV1 orderControllerV1(LogTrace logTrace){
        OrderControllerV1 orderController = new OrderControllerImpl(orderServiceV1(logTrace));
